...
// We trust private IPs (Render's internal load balancers) AND Cloudflare's public IP ranges.
// This ensures Express strips both the Render proxy and Cloudflare proxy from X-Forwarded-For
// to securely resolve the real client IP, without throwing the rate-limit permissive proxy error.
